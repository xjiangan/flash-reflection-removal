...
train_dirs=["calculus","exam","bio","scratch",'bio3','bio4','bio5','exam3','exam4']
val_dirs=["bio2","bio6",'exam2']
train_dfs=[]
...
train_ds=train_ds.map(lambda x:load_four_raw(x),
            num_parallel_calls=4).repeat(23).batch(BATCH_SIZE).prefetch(BATCH_SIZE)
